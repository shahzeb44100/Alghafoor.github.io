...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Get a Quick Quote From Us | AlGhafoor Salts</title>
...
session_start();
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST["name"]) || empty($_POST['email']) || empty($_POST['message'])){
            ...
            $to = "<info@alghafoorint.com>";//<-----Put Your email address here.
            $name = $_POST['name']; 
            ...
            if($done == True){
               ...
               echo '<script>alert("Your mail is not Sent!")</script>';
            }
      ...
      <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>Get a Quick Quote From Us</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <!-- <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                           ...
                           <input type="hidden" name="_captcha" value="false"/>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input class="form-control" value="" placeholder="Your name" type="text" name="name">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                              <input class="form-control" value="" placeholder="Email" type="text" name="email">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
